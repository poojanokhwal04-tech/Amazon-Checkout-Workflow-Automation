...
class PRODUCTDETAILS:
    ...
    def click_on_buy_now(self):
        self.wait.until(EC.visibility_of_element_located((By.ID, self.button_buynow_id))).click()
    ...
    def verify_product_details_page(self):
        return self.wait.until(EC.visibility_of_element_located((By.ID,self.button_buynow_id))).is_displayed()
    ...
    def get_product_price(self):
        subtotal = self.wait.until(EC.visibility_of_element_located((By.XPATH, self.text_productprice_xpath))).text
